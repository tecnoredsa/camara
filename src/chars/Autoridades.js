...
export default function App() {
    ...
    const fetchUser = async (value) => {
        ...
        const response = await fetch('https://www.sit-zac.org.mx/guardar_servicio_estadisticas_autoridades', {
            method: 'post',
        ...
        setDemandados(result.data_char1.data_char);
        setActores(result.data_char2.data_char2);
        setCargando(false);
    }
                ...
                >
                    ...
                    <ScrollView vertical={true}>
                        <Center>
                            ...
                            <Badge colorScheme="info" mb="2" variant="outline" >Demandados</Badge>
                            ...
                            <Divider my="2" />
                            <Badge colorScheme="info" mb="2" variant="outline" >Actores</Badge>
                            <ScrollView style={styles.scrollView} horizontal={true}>
                                <PieChart
                                    data={actores}
                                    width={screenWidth}
