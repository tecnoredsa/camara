...
export default function App() {
    ...
    const fetchUser = async (value) => {
        ...
        const response = await fetch('https://www.sit-zac.org.mx/guardar_servicio_estadisticas_gene_acuerdos', {
            method: 'post',
                ...
                >
                    ...
                    <ScrollView vertical={true}>
                        <Center>
                            ...
                            <Badge colorScheme="info" mb="2" variant="outline">Total de acuerdos {datos.total}</Badge>
                            <LineChart
                                data={{
                                    labels: datos.label,
                                    datasets: [
                            ...
                            <Divider my="2" />
                            <Badge colorScheme="info" mb="2" variant="outline" >Tipos de acuerdos</Badge>
                            ...
                            <Divider my="2" />
                            <Badge colorScheme="info" mb="2" variant="outline" >Tipos</Badge>
                            <ScrollView style={styles.scrollView} horizontal={true}>
                                <PieChart
                                    data={asig}
                                    width={screenWidth}
