...
export default function Example({ route, navigation }) {
    ...
    const fetchUser = async () => {
        ...
        const response = await fetch('https://www.sit-zac.org.mx/guardar_servicio_mostrar_acuerdo', {
            method: 'post',
    ...
    if (cargando) {
        return (
            <Loading texto={'Cargando acuerdo'} />
                ...
                <Center flex={1} px="3">
                    ...
                    >
                        ...
                        <Stack p="4" space={3}>
                            ...
                            <Button
                                onPress={() => Linking.openURL('https://sit-zac.org.mx/SALAS/acuerdos/' + datos.acuerdo)}
                                variant="subtle"
                                endIcon={<Icon as={Ionicons} name="cloud-download-outline" size="sm" />}
                            >
                                Descargar acuerdo
                            </Button>
                            <Share_ title={'Hola te comparto el acuerdo'} uri={'https://sit-zac.org.mx/SALAS/acuerdos/' + datos.acuerdo} />
