...
import { HStack, AspectRatio, Text, Heading, FlatList, Box, Input, Icon, Stack, Center, NativeBaseProvider, Button, Badge, Spacer, Spinner, Hidden } from "native-base";
...
const CarouselCardItem = ({ item, index, navigation }) => {
    return (
        <TouchableHighlight
            ...
            onPress={() => navigation.navigate('DetalleServicios', { id_servicio: item.id })}
        >
            <Center flex={1} px="3">
                <Box
                    maxW="800"
